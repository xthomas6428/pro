...
if (isset($_POST['sale_submit'])) {
    ...
    try {
        ...
        $message->add('danger', 'The sale end date must use the m/d/Y format!');
    }
...
<form method="POST" style="width: 100%;" class="form-horizontal" role="form">
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('packages'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('percentage', 'Percentage'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('message', 'Message'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('end_date', 'End date'); ?></label>
    ...
    <div class="form-group form-row">
        <div class="col-offset-2 col-10">
            <input type="submit" name="sale_submit" style="margin-top: 5px;" class="btn btn-success"
                   value="<?= lang('submit'); ?>">
        </div>
    </div>
</form>