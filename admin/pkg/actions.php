...
if (isset($_POST['rank'])) {
    ...
    $rank_before = isset($_POST['rank_before']) ? 1 : 0;
    $rank_prefix = isset($_POST['rank_prefix_tick']) ? strip_tags($_POST['rank_prefix']) : '';
...
if (isset($_POST['pointshop1'])) {
    ...
    $pointshop1_mysql = isset($_POST['pointshop1_mysql']) ? 1 : 0;
...
if (isset($_POST['pointshop2'])) {
    ...
    $pointshop2_mysql = isset($_POST['pointshop2_mysql']) ? 1 : 0;
...
$comp = isset($_POST['comp']) ? checkboxArrayStrip($_POST['comp']) : '[]';
