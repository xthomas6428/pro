  ...
  <div class="form-group form-row">
    <div class="col-12">
      <div class="checkbox">
        ...
        <label>Ulib(ULX), Evolve, Moderator, AssMod, sAdmin, xAdmin, xAdmin 2, SAM, ServerGuard</label>
        ...
        >
          ...
          >
            ...
            <input
              ...
              value="<?= actions::get($_GET['id'], 'rank', 'rank_after'); ?>"
            >
          </div>
          <br>
          <input
      ...
      <div class="checkbox">
        ...
        >
          ...
          <input
            ...
            style="margin-top: 5px; margin-bottom: 5px;"
            class="form-control"
            name="pointshop2_premium"
            placeholder="Premium Points (Number)"
    ...
    <div class="col-12">
      <div class="checkbox">
        ...
        >
          ...
          <h6 style="margin-top: 20px;">Weapons</h6>

          <input
            type="checkbox"
            class="customjob_weapons_check"
          ...
          <div
            class="customjob_weapons"
            style="<?php echo actions::get($_GET['id'], 'customjob', 'weapons') ? '' : 'display: none;'; ?>"
          >
            <div id="customjob_weapons_list">
                <?= actions::customjob($_GET['id'], 'weapons'); ?>
            </div>

            <div class="row">
              <div class="col-12">
                <div id="addWeapon" style="width: min-content">
                  <i
                    class="fas fa-plus fa-2x"
                    style="color: darkgreen; cursor:pointer; margin-top: 10px"
                    id="addWeapon"
                  ></i>
                </div>
              </div>
            ...
            >
              <div class="col-3">
                How many do you want the user to be able to buy?
                <input
                  type="number"
                  class="form-control"
                  style="margin-top: 5px;"
                  name="customjob_weapons_max"
            ...
            $('#addWeapon').on('click', function () {
              ...
              var value = '<div class="row weapon">' +
                  '<div class="col-md-3">' +
                  ...
                  '</div>' +
                  '<div class="col-md-1">' +
                  '<div style="width: min-content" class="delWeapon"><i class="fas fa-minus-circle fa-fw" style="color: #c10000; cursor:pointer; margin-top: 14px;"></i></div>' +
                  '</div>' +
                  '</div>';
          ...
          <div
            class="customjob_weapons2"
            style="<?php echo actions::get($_GET['id'], 'customjob', 'weapons') ? 'display: none;' : ''; ?>"
          >
            <input
              type="text"
              name="customjob_weapons_static"
              class="form-control"
              style="margin-top: 5px;"
          ...
          <h6 style="margin-top: 20px;">Friends</h6>
          <input
            type="checkbox"
            class="customjob_friends_check"
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <input
                  ...
                  step="any"
                  min="0"
                  name="customjob_friends_scaleprice"
                  class="form-control"
                  style="margin-top: 5px;"
                ...
                <?php if ($credits_enabled == 1) { ?>
                  <div class="col-12 col-md-6">
                    <input
                      ...
                      step="any"
                      min="0"
                      name="customjob_friends_scalecredits"
                      class="form-control"
                      style="margin-top: 5px;"
          ...
          <div
            class="customjob_friends2"
            style="<?php echo actions::get($_GET['id'], 'customjob', 'friends') ? 'display: none;' : ''; ?>"
          >
            <input
              type="number"
              name="customjob_friends_static"
              class="form-control"
              style="margin-top: 5px;"
              placeholder='Amount of friends to include'
              value="<?= actions::get($_GET['id'], 'customjob', 'friends_static'); ?>"
            >
          </div>


          <h6 style="margin-top: 20px;">Salary</h6>
          <input
            type="checkbox"
            class="customjob_salary_check"
            name="customjob_salary_check" <?php echo actions::get($_GET['id'], 'customjob', 'salary') ? 'checked' : ''; ?>>
          <label>Let the user define salary</label>

          <div
            class="customjob_salary"
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <input
                  ...
                  step="any"
                  min="0"
                  name="customjob_salary_scaleprice"
                  class="form-control"
                  style="margin-top: 5px;"
                ...
                <?php if ($credits_enabled == 1) { ?>
                  <div class="col-12 col-md-6">
                    <input
                      type="number"
                      name="customjob_salary_scalecredits"
                      class="form-control"
                      style="margin-top: 5px;"
          ...
          <div
            class="customjob_salary2"
            style="<?php echo actions::get($_GET['id'], 'customjob', 'salary') ? 'display: none;' : ''; ?>"
          >
            <input
              type="number"
              name="customjob_salary_static"
              class="form-control"
              style="margin-top: 5px;"
              placeholder="Salary (Static amount)"
              value="<?= actions::get($_GET['id'], 'customjob', 'salary_static'); ?>"
            >
          </div>

          <h6 style="margin-top: 20px;">Model</h6>
          <input
            type="checkbox"
            class="customjob_models_check"
          ...
          >
            ...
            <div class="row">
              <div class="col-12 col-md-12">
                <div id="addModel" style="width: min-content">
                  <i
                    class="fas fa-plus fa-2x fa-fw"
                    style="color: darkgreen; cursor:pointer; margin-top: 10px"
                  ></i>
                </div>
              </div>
            ...
            $('#addModel').on('click', function () {
              ...
              var value = '<div class="row model">' +
                  ...
                  '</div>' +
                  '<div class="col-md-1">' +
                  '<div style="width: min-content" class="delModel"><i class="fas fa-minus-circle fa-fw" style="color: #c10000; cursor:pointer; margin-top: 14px;"></i></div>' +
                  '</div>' +
                  '</div>';
          ...
          <div
            class="customjob_models2"
            style="<?php echo actions::get($_GET['id'], 'customjob', 'models') ? 'display: none;' : ''; ?>"
          >
            <input
              type="text"
              name="customjob_models_static"
              class="form-control"
              style="margin-top: 5px;"
          ...
          <h6 style="margin-top: 20px;">License</h6>
          <input
            type="checkbox"
            class="customjob_license_check"
          ...
          >
            <div class="row">
              <div class="col-12">
                <input
                  type="number"
                  name="customjob_license_scaleprice"
                  class="form-control"
                  style="margin-top: 5px;"
                  placeholder="Price to add if user chooses yes"
                ...
                <?php if ($credits_enabled == 1) { ?>
                  <div class="col-12">
                    <input
                      type="number"
                      name="customjob_license_scalecredits"
                      class="form-control"
                      style="margin-top: 5px;"
                      placeholder="Credits to add if user chooses yes"
          ...
          <div
            class="customjob_license2"
            style="<?php echo actions::get($_GET['id'], 'customjob', 'license') ? 'display: none;' : 'margin-top: 20px;'; ?>"
          >
            <input
              type="checkbox"
              class="customjob_license_static"
      ...
      <div class="checkbox">
        ...
        >
          ...
          <input
            ...
            style="margin-top: 5px;"
            value="<?= actions::get($_GET['id'], 'weapons', 'string'); ?>"
          >
        </div>
      </div>
    </div>
      ...
      <div class="checkbox">
        ...
        >
          ...
          <input
            type="text"
            class="form-control"
            name="console_cmd_when"
            placeholder="CMD Ran at above action"
            style="margin-top: 5px;"
          ...
          <input
            type="text"
            class="form-control"
            name="console_cmd_after"
            placeholder="CMD Ran after expired"
            style="margin-top: 5px;"
            value='<?= actions::get($_GET['id'], 'console', 'cmd_after'); ?>'
          >
        </div>
      </div>
    </div>
    ...
    <div class="col-12">
      <div class="checkbox">
        ...
        >
          ...
          <code>Prometheus.Temp.MoneySpent</code> - The cash or credits the player spent on the package. <br>
          <code>Prometheus.Temp.CashSpent</code> - The cash the player spent on the package. <br>
          <code>Prometheus.Temp.CreditsSpent</code> - The credits the player spent on the package. <br>
          <code>Prometheus.Temp.MoneyEverSpent</code> - The money the player has ever spent on any packages or
          credit packages combined (this value does not include credits).<br>
          ...
          <textarea
            ...
            class="form-control"
          ><?= actions::get($_GET['id'], 'custom_action', 'code_when'); ?></textarea>

          <input
            type="checkbox"
            id="custom_action_after"
          ...
          >
            ...
            packages or credit packages combined (this value does not include credits).<br>
            These are case sensitive!
            <textarea
              name="code_after"
              placeholder="Code snippet"
              style="margin-top: 5px; margin-bottom: 15px; height: 300px; max-width: 100%;"
              class="form-control"
            ><?= actions::get($_GET['id'], 'custom_action', 'code_after'); ?></textarea>
          </div>
        </div>
      </div>
    </div>
        ...
        >
          ...
          >
            ...
            <input
              type="text"
              class="form-control"
              name="teamspeak_group"
              placeholder="Server group to give the user"
              style="margin-top: 5px;"
          ...
          <div
            id="teamspeak_channel_options"
            style="margin-top: 5px; <?php echo actions::get($_GET['id'], 'teamspeak', 'channel_parent') ? '' : 'display: none;'; ?>"
          >
            <input
              type="text"
              class="form-control"
              name="teamspeak_channel_parent"
              placeholder="Channel ID of the parent channel"
              style="margin-top: 5px;"
            ...
            <input
              type="text"
              class="form-control"
              name="teamspeak_channel_group"
              placeholder="Group ID of the channel admin rank"
              style="margin-top: 5px;"
...
<div
  id="pkg-step-3-content"
  style="display: none;"
>
  <div id="link_expire" <?= getEditPackage($id, 'permanent') == 1 ? 'style="display: none"' : ''; ?>>
    <div class="form-group form-row">
      <div class="col-12">
        <h2><?= lang('link_expire', 'Link expiration time'); ?></h2>
          <?= lang('link_expire_text', "If you own any of the selected packages, and they have not expired, this package adds their expire time to this one and deactivates the other ones"); ?>
      </div>
    </div>
    <div class="form-group form-row">
      <div class="col-12">
          <?= checkbox_getPackages($_GET['id'], 'expire'); ?>
      </div>
    </div>
  </div>
