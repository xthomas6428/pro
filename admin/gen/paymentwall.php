...
<form method="POST" style="width: 100%;" class="form-horizontal" role="form">
    ...
    <?php if (gateways::enabled('paymentwall')) { ?>
        <hr>
        <div class="form-group form-row">
            <label class="col-2 control-label">Project Key</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Secret Key</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Widget ID</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Review Key</label>
    ...
    <div class="form-group form-row">
        <div class="col-10">
            <input type="submit" name="paymentwall_submit" value="<?= lang('submit'); ?>" class="btn btn-success"
