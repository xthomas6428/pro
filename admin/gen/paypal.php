...
<form method="POST" style="width: 100%;" class="form-horizontal" role="form">
    ...
    <?php if (gateways::enabled('paypal')) { ?>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Paypal Email</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Return URL</label>
            ...
            <div class="col-1">
                <button type="button" class="help-box" data-toggle="tooltip" data-placement="bottom"
                        title="This is the URL you want to direct your users to after a successful payment.">?
                </button>
            </div>
        </div>
        <div class="form-group form-row">
            <label class="col-2 control-label">Cancel URL</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">IPN URL</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Payment Type</label>
    ...
    <div class="form-group form-row">
        <div class="col-10">
            <input type="submit" name="paypal_submit" value="<?= lang('submit'); ?>" class="btn btn-success"
