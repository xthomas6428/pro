...
if (isset($_POST['settings_submit'])) {
    ...
    if (isset($_POST['store_disable_read_more'])) {
        $store_disable_read_more = 1;
    } else {
        $store_disable_read_more = 0;
    }
    ...
    if (isset($_POST['advent_claim_current_day_only'])) {
        $advent_claim_current_day_only = 1;
    } else {
        $advent_claim_current_day_only = 0;
    }
    ...
    setSetting($store_disable_read_more, 'store_disable_read_more', 'value2');
    ...
    setSetting($advent_claim_current_day_only, 'advent_claim_current_day_only', 'value2');
...
<form method="POST" style="width: 100%;" class="form-horizontal form" role="form">
    ...
    <div class="darker-box">
        <div class="form-group form-row">
            <label class="col-2 control-label">Site Title</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Banner URL</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Logo URL</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Default theme</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Main Currency</label>
    ...
    <div class="darker-box">
        <div class="form-group form-row">
            <label class="col-2 control-label">Featured pkg</label>
        ...
        <div class="form-group form-row">
            <label class="col-2 control-label">Package display</label>

            <div class="col-9">
                <select name="package_display" class="selectpicker" data-style="btn-prom">
                    <?php foreach ($displays as $key => $display) { ?>
                        <option value="<?= $key; ?>" <?= $key == getSetting('store_packageDisplay', 'value2') ? 'selected' : ''; ?>><?= $display; ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="col-1">
        ...
        <div class="form-group form-row">
            <div class="offset-2 col-9">
                <div class="checkbox">
                    <input type="checkbox"
                           name="store_disable_read_more" <?php echo getSetting('store_disable_read_more', 'value2') == 1 ? 'checked' : ''; ?>>
                    <label>Disable read more functionality</label>
                </div>
            </div>
            <div class="col-1">
                <button type="button" class="help-box" style="margin-top: 7px;" data-toggle="tooltip"
                        data-placement="bottom"
                        title="Do you want to disable the read more button on packages description?">?
                </button>
            </div>
        </div>
        <div class="form-group form-row">
    ...
    <div class="darker-box">
        ...
        <div class="form-group form-row">
            <div class="offset-2 col-9">
                <div class="checkbox">
                    <input type="checkbox"
                           name="advent_claim_current_day_only" <?php echo getSetting('advent_claim_current_day_only', 'value2') == 1 ? 'checked' : ''; ?>>
                    <label>Only allow opening of current advent day</label>
                </div>
            </div>

            <div class="col-1">
                <button type="button" class="help-box" style="margin-top: 7px;" data-toggle="tooltip"
                        data-placement="bottom" title="Disallows opening of advent squares that have already been">?
                </button>
            </div>
        </div>
    ...
    <div class="form-group form-row">
        <div class="offset-2 col-10">
            ...
            <input type="submit" name="settings_submit" value="<?= lang('submit'); ?>" class="btn btn-success"
