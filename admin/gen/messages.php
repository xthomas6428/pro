...
<form method="POST" style="width: 100%;" class="form-horizontal" role="form">
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label">Permanent</label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label">Non Permanent</label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label">Revoked</label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label">Expired</label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label">Others</label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label">Receiver credits</label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label">Others credits</label>
    ...
    <div class="form-group form-row">
        <div class="offset-2 col-10">
            ...
            <input type="submit" name="messages_submit" value="<?= lang('submit'); ?>" class="btn btn-success"
