...
<form method="POST" style="width: 100%;" class="form-horizontal form" role="form">
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('company_name'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('street_address'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('post_address'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('country'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('trade_register'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('company_id'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('company_ceo'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('contact_email'); ?></label>
    ...
    <div class="form-group form-row">
        <label class="col-2 control-label"><?= lang('contact_phone'); ?></label>
    ...
    <div class="form-group form-row">
        <div class="offset-2 col-10">
            ...
            <input type="submit" name="imprint_submit" value="<?= lang('submit'); ?>" class="btn btn-success"
