...
<form method="POST" style="width: 100%;" class="form-horizontal" role="form">
    ...
    <div class="form-group form-row">
        <label class="col-3 control-label">Server query username</label>
    ...
    <div class="form-group form-row">
        <label class="col-3 control-label">Server query password</label>
    ...
    <div class="form-group form-row">
        <label class="col-3 control-label">Query port</label>
    ...
    <div class="form-group form-row">
        <label class="col-3 control-label">Virtualserver ID</label>
    ...
    <div class="form-group form-row">
        <label class="col-3 control-label">Server IP</label>
    ...
    <div class="form-group form-row">
        <label class="col-3 control-label">Server port</label>
    ...
    <div class="form-group form-row">
        <div class="offset-3 col-9">
            <input type="submit" name="teamspeak_submit" value="<?= lang('submit'); ?>" class="btn btn-success"
