...
if (prometheus::loggedIn() && prometheus::isAdmin()) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!$error) {
            ...
            if ($id != '') {
                $db->execute(
                    "UPDATE raffles SET title = ?, descr = ?, package = ?, end_amount = ?, max_per_person = ?, price = ?, credits = ?, img = ? WHERE id = ?",
                ...
                $db->execute(
                    "INSERT INTO raffles SET title = ?, descr = ?, package = ?, end_amount = ?, max_per_person = ?, price = ?, credits = ?, img = ?",
...
<div class="content-page-top">
    <span><i class="fas fa-puzzle-piece fa-fw"></i> <?= lang('raffles'); ?></span>
</div>
        ...
        <div class="container-fluid">
            ...
            <?php if (isset($_GET['id']) && isset($_GET['id']) or isset($_GET['add'])) { ?>
                ...
                <form method="POST" style="width: 100%;" enctype="multipart/form-data" class="form-horizontal form"
                    ...
                    <input type="hidden" name="csrf_token" value="<?= csrf_token(); ?>">
                    <div class="form-group form-row">
                        <label class="col-2 control-label">Raffle title</label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label">Raffle desc</label>
                    ...
                    <?php if (getSetting('credits_only', 'value2') == 0) { ?>
                        <div class="form-group form-row">
                            <label class="col-2 control-label">Price</label>
                    ...
                    if (gateways::enabled('credits')) { ?>
                        <div class="form-group form-row">
                            <label class="col-2 control-label">Credits</label>
                    ...
                    <?php } ?>
                    <div class="form-group form-row">
                        <label class="col-2 control-label">Package</label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label">End Amount</label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label">Max Per Person</label>
