...
if (prometheus::loggedIn() && prometheus::isAdmin()) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!is_numeric($_POST['percent']) or $_POST['percent'] < 1 or $_POST['percent'] > 100) {
            $error = true;
            $message->add('danger', "The off percentage must not be lower than 1, not higher than 100 and must be a number");
        }
...
<div class="content-page-top">
    <span><i class="fas fa-calendar-minus"></i> <?= lang('coupons'); ?></span>
</div>
            ...
            <div class="container-fluid">
                ...
                <?php if (isset($_GET['id']) or isset($_GET['add'])) { ?>
                    <form method="POST" style="width: 100%;" class="form-horizontal form" role="form">
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label">Coupon code</label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label">Coupon description</label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label">Amount of uses</label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label">Off percentage</label>

                            <div class="col-10">
                                <input name="percent" type="number" class="form-control" placeholder="1-100" max="100" min="1" value="<?= coupon::getValue($id, 'percent'); ?>">
                            </div>
                        </div>

                        <div class="form-group form-row">
                            <label class="col-2 control-label">Expire date</label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label">Packages</label>
                        ...
                        <div class="form-group form-row">
                            <div class="offset-2 col-10">
                                ...
                                <input type="submit" value="<?= lang('submit'); ?>" class="btn btn-success" name="submit"
