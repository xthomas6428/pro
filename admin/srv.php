...
<div class="content-page-top">
    <span><i class="fas fa-server fa-fw"></i> <?= lang('servers'); ?></span>
</div>
        ...
        <div class="container-fluid">
            ...
            <?php if (isset($_GET['id']) or isset($_GET['add'])) { ?>
                <form method="POST" style="width: 100%;" class="form-horizontal form" role="form">
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label"><?= lang('game'); ?></label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label"><?= lang('server_name'); ?></label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label"><?= lang('order_id', 'Order ID'); ?></label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label">Image link</label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label"><?= lang('featured_pkg_short'); ?></label>
                    ...
                    <div style="<?= getEditServer($id, 'game') != 'gmod' && $id != '' ? '' : 'display: none;'; ?>"
                         id="gameOptions">
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('server_ip'); ?></label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('server_port'); ?></label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('server_rcon'); ?></label>
