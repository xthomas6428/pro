        ...
        <div class="container-fluid">
            ...
            <?php if (isset($_GET['id']) or isset($_GET['add'])) { ?>
                ...
                <form method="POST" class="form-horizontal form">
                    ...
                    $content = new theme_checkbox(
                        ...
                        array(
                            ...
                            [
                                ...
                                'class' => '.dashboard-widget-small-box svg, #sortable li svg',
                                'classtype' => 'color',
                            ],
                            [
                    ...
                    $admin_pageheader = new theme_checkbox(
                        ...
                        array(
                            ...
                            [
                                ...
                                'class' => '.content-page-top > span > svg',
                                'classtype' => 'color',
                            ],
                            [
                                'title' => 'Arrow colour',
                    ...
                    <input type="submit" class="btn btn-success" value="<?= lang('submit'); ?>" name="theme_submit">
                </form>
