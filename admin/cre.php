...
<div class="content-page-top">
    <span><i class="fas fa-coins fa-fw"></i> <?= lang('credit_packages'); ?></span>
</div>
            ...
            <div class="container-fluid">
                ...
                <?php if (isset($_GET['id']) or isset($_GET['add'])) { ?>
                    <form method="POST" style="width: 100%;" class="form-horizontal form" role="form">
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('pack_title'); ?></label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('amount', 'Amount'); ?></label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('price', 'Price'); ?></label>
