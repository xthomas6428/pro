...
<div class="content-page-top">
    <span><i class="fas fa-bookmark fa-fw"></i> <?= lang('categories'); ?></span>
</div>
        ...
        <div class="container-fluid">
            ...
            <?php if (isset($_GET['id']) or isset($_GET['add'])) { ?>
                <form method="POST" style="width: 100%;" class="form-horizontal form" role="form">
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label"><?= lang('cat_name'); ?></label>
                    ...
                    <div class="form-group form-row">
                        <label class="col-2 control-label">Order ID</label>
