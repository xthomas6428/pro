...
<div class="content-page-top">
    <span><i class="fas fa-cubes fa-fw"></i> <?= lang('packages_and_actions'); ?></span>
</div>
                ...
                <form method="POST">
                    ...
                    <div class="package-disabled">
                        <input type="submit" value="Enable Package" class="btn btn-success"
                               name="pkg_enable" style="margin-top: 5px; margin-bottom: 15px;">
                    </div>
                </form>
            <?php } ?>
                ...
                <form method="POST" enctype="multipart/form-data" class="form-horizontal form" role="form">
                    ...
                    <div id="pkg-step-1-content" style="display: none;">
                        <div class="form-group form-row">
                            <label
                                    class="col-2 control-label"><?= lang('label_amount'); ?></label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('title', 'Title'); ?></label>
                        ...
                        <div id="display_img"
                            ...
                            <div class="form-group form-row">
                                <label class="col-2 control-label">Display image</label>
                            ...
                            <div class="form-group form-row">
                                <label class="col-2 control-label">Image URL</label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('category', 'Category'); ?></label>
                        ...
                        <div id="price_options" <?= getEditPackage($id, 'custom_price') ? 'style="display: none;"' : ''; ?>>
                            <?php if (getSetting('credits_only', 'value2') == 0) { ?>
                                <div class="form-group form-row">
                                    <label class="col-2 control-label"><?= lang('price'); ?></label>

                                    <div class="col-10">
                                        <input type="text" placeholder="0.00 (<?= lang('price'); ?>)"
                                               class="form-control" value="<?= getEditPackage($id, 'price'); ?>"
                                               name="pkg_price" style="display: inline-block;">
                                    </div>
                                </div>
                            <?php } ?>
                            ...
                            <?php if (gateways::enabled('credits')) { ?>
                                <div class="form-group form-row">
                                    <label class="col-2 control-label"><?= lang('credits'); ?></label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('servers'); ?></label>
                        ...
                        <div id="labels" class="form-group form-row"
                             style="margin-top: -5px; <?php echo $c == 0 ? 'display: none;' : '' ?>">
                            <label class="col-2 control-label"><?= lang('labels', 'Labels'); ?></label>
                        ...
                        <div class="form-group form-row">
                            <label class="col-2 control-label"><?= lang('description'); ?></label>

                            <div class="col-10">
                                    <textarea
                                            placeholder="..."
                                            class="form-control tinymce" style="max-width: 100%;" id="pkg_desc"
                        ...
                        <div class="form-group form-row" id="subscription">
                            <div class="offset-2 col-10">
                                <div class="checkbox">
