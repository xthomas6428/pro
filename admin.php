...
<?php if (prometheus::loggedIn() && prometheus::isAdmin() && getSetting('installed', 'value2')) { ?>
    <div class="full-content-wrapper d-flex flex-column d-md-block">
        <?php
            ...
            if (isset($_GET['a']) && $_GET['a'] !== 'dashboard') {
                ...
                echo '
						<div class="content-page-top">
						    <span><i class="fas fa-chart-pie fa-fw mr-1"></i>Dashboard</span>
						</div>
