        ...
        <ul>
            <a href="admin.php">
                <li class="<?php echo $_GET['a'] == '' ? 'active' : ''; ?>">
                    <div class="nav-icons"><i class="fas fa-fw fa-chart-pie"></i></div> <?= lang('dashboard'); ?></li>
            </a>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-cogs"></i></div> <?= lang('general_settings'); ?>
                    <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                </li>
            </a>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-gavel"></i>
            ...
            <?php if (getSetting('support_tickets', 'value2') == 1) { ?>
                <a href="admin.php?a=sup">
                    <li class="d-flex align-items-center <?php echo $_GET['a'] == 'sup' ? 'active' : ''; ?> <?php echo !permissions::has("support") ? 'disabled' : ''; ?>">
                        <div class="nav-icons"><i class="fas fa-fw fa-ticket-alt"></i>
                        </div> <?= lang('support_tickets'); ?><?php if (tickets::read(1) != 0) { ?><span
                            class="badge badge-dark notification ml-auto"><?php echo tickets::read(1); ?></span><?php } ?></li>
                </a>
            <?php } ?>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-server"></i></div> <?= lang('servers'); ?>
                    <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                </li>
            </a>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-money-bill"></i></div> <?= lang('currencies'); ?>
                    <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                </li>
            </a>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-bookmark"></i></div> <?= lang('categories'); ?>
                    <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                </li>
            </a>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-cubes"></i></div> <?= lang('packages_and_actions'); ?>
                    <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                </li>
            </a>
            ...
            <?php if (gateways::enabled('credits')) { ?>
                <a href="#">
                    <li data-toggle="collapse"
                        ...
                        <div class="nav-icons"><i class="fas fa-fw fa-coins"></i></div> <?= lang('credit_packages'); ?>
                        <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                    </li>
                </a>
            ...
            <?php if (getSetting('enable_raffle', 'value2') == 1) { ?>
                <a href="#">
                    <li data-toggle="collapse"
                        ...
                        <div class="nav-icons"><i class="fas fa-fw fa-puzzle-piece"></i></div> <?= lang('raffles'); ?>
                        <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                    </li>
                </a>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-calendar-minus"></i></div> <?= lang('coupons'); ?>
                    <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                </li>
            </a>
            ...
            <a href="#">
                <li data-toggle="collapse"
                    ...
                    <div class="nav-icons"><i class="fas fa-fw fa-bars"></i></div> <?= lang('theme_editor'); ?>
                    <div class="float-right"><i class="fas fa-fw fa-angle-right"></i></div>
                </li>
            </a>
            ...
            <a href="admin.php?a=adv">
                <li class="<?php echo $_GET['a'] == 'adv' ? 'active' : ''; ?>">
                    <div class="nav-icons"><i class="fas fa-fw fa-tree"></i></div> <?= lang('advent_calendar'); ?></li>
            </a>
            <?php } ?>

            <a href="http://wiki.prometheusipn.com/" target="_blank">
                <li class="">
                    <div class="nav-icons"><i class="fas fa-fw fa-book"></i></div> <?= lang('wiki', 'Wiki'); ?></li>
            </a>
        </ul>
    </div>
    <div class="version-marker d-none d-md-block text-center">
