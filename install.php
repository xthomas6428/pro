...
try {
    $res = $db->getOne("SELECT count(*) FROM settings");
...
<?php if (getSetting('installed', 'value2') == 0) { ?>
  <div class="content">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="bs-callout bs-callout-info">Your License key (API key) is found at nmscripts.com!
          </div>
          <br>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <input
                    ...
                    value="<?php if (isset($_POST['install_key'])) {
    echo $_POST['install_key'];
                ...
                <div class="col-md-1">
                  <button
                    ...
                    title="Go to http://nmscripts.com/ and click 'Sign In'. After signing in you will see an 'API Key' setting."
                  >
                    ?
                  </button>
                </div>
            ...
            <div class="form-group">
              <div class="row">
                <label class="col-md-2 control-label">Site Title</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <input
                      ...
                      value="<?php if (isset($_POST['install_email'])) {
    echo $_POST['install_email'];
              ...
              <div class="form-group">
                <div class="row">
                  <label class="col-md-2 control-label">IPN URL</label>
              ...
              <div class="form-group">
                <div class="row">
                  <label class="col-md-2 control-label">Cancel URL</label>
            ...
            >
              <div class="form-group">
                <div class="row">
                  <label class="col-md-2 control-label">Project Key</label>

                  <div class="col-md-9">
                    <input
                      type="text"
                      class="form-control"
                      name="paymentwall_project"
                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <input
                      type="text"
                      class="form-control"
                      name="paymentwall_widgetID"
                      placeholder="Paymentwall WidgetID"
                      value="p10_1"
                    >
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-1">
                    <button
                      ...
                      data-toggle="tooltip"
                      data-placement="bottom"
                      title="Your live webhook secret found on your Stripe account. View the Prometheus wiki if you are unsure about this!"
                    >
                      ?
                    </button>
                  </div>
